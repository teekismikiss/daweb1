        ...
        <nav class="nav-header">
            <ul>
               <li><a href="#">Inicio</a></li>
                ...
                <li><a href="certificacion.php">Certificacion</a></li>
...
<h1>Felicidades <?=$nombrealumno?> ahora eres un <?= $moteCoder?>Pro </h1>

<h3>Se ortoga el presente  Certificado de Finalización a :</h3>
<h2> <?=$nombrealumno?> </h2>

<p>Por haber completado con éxito el curso de <?=$nombreCurso?> en <?=$nombrealumno?>!!/P>
