<!-- index.php  esta version crea una funcion para meter el  $arrayDatos donde quieras creando una function.  -->
...
function listarFruta(){
    global $arrayDatos; // llamar a variable / array externo a la función
